              ...
              <li className="mb-[30px] w-1/3 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                  <img
                    ...
                    alt="image"
                  />
                  <span className="block">Eskisehir, Turkiye</span>
                </div>
              </li>
              <li className="mb-[30px] w-1/3 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
              ...
              <li className="mb-[30px] w-1/3 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                  <img
                    ...
                    alt="image"
                  />
                  <span className="block">+90 545 xxx xxxx</span>
                </div>
              </li>
            </ul>
          </div>
                ...
                <div className="mapouter">
                  <div className="gmap_canvas">
                    <iframe
                      ...
                      height={355}
                      id="gmap_canvas"
                      src="https://maps.google.com/maps?q=eskisehir&t=&z=13&ie=UTF8&iwloc=&output=embed"
                      frameBorder={0}
                      scrolling="no"
                      marginHeight={0}
                      marginWidth={0}
